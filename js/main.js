    ...
    fetch(url, {
        ...
        .then(data => {
            ...
            if (sign === "aries" || sign === "taurus" || sign === "gemini" || sign === "cancer" || sign === "leo" || sign === "virgo" || sign === "libra" || sign === "scorpio" || sign === "sagittarius" || sign === "capricorn" || sign === "aquarius" || sign === "pisces") {
                ...
                document.querySelector('#date-range').innerText = 'Date Range'
                document.querySelector('#lucky-color').innerText = 'Lucky Color'
                document.querySelector('#mood').innerText = 'Feels'
